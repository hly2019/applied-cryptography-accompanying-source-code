...
{
    unsigned long work[8] = {0, 0, 0, 0, 0, 0, 0, 0};
...
int test_des(
    ...
    des_ctx dc;
    int i;
    unsigned int data[10] = {0, 0, 0, 0, 0, 0, 0, 0};
    unsigned char *cp,key[8] = {key0, key1, key2, key3, key4, key5, key6, key7};
...
// int main() {
//     test_des(0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef);
// }